...
$query = "SELECT * FROM athletes WHERE 1 ORDER BY bracket ASC, bracket_rank ASC;";
if ($bracket != 'Overall'){
	$query = "SELECT * FROM athletes WHERE bracket = '$bracket' ORDER BY bracket_rank ASC";
}
...
<html>
    ...
    <body>
        <div class="container">
			...
			<br>
            <div class="row placeholder">
					<form id="find" action="all.php" method="get">
            ...
            <div class="bs-example" >
                <div class="panel panel-primary">
                    ...
                    <thead>
                        <tr>
                            <th>Rank</th> <th>Nombre</th> <th>Categoría</th> <th>Giros y Tiempo</th>
                        </tr>
                    </thead>
                        <tbody>
                            <?php while($row = mysql_fetch_array($response)) { ?>
                              <tr>
								...
								<td><h4 class="top" >
                                     <span class="name"><?php echo strtoupper($row['bracket']);?></span>
                                </td>
								<td><h4>
