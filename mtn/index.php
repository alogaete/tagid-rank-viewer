...
<html lang="es">
    <head>
        ...
        <?php if($num > 0){?> <META http-equiv="refresh" content="300;URL=http://45.56.121.235/mtn"> <?php }?>
                    ...
                    <form method="get" role="form">
                        <div class="panel panel-primary">
                          <div class="panel-heading">
                            <h2 align="center"> Ingresa tu N&uacute;mero</h2>
                          </div>
                          ...
                          <div class="panel-footer">
                            <input class="btn btn-primary center-block btn-lg" type="submit" value="Revisar N&uacute;mero">
                          </div>
                        </div>                   
